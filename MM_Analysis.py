...
PATH_TO_EXCEL = "TabelleMyelomAllebis2006-_alle_Patienten.xlsx"
...
def readExcel():
    ...
    # Drop Rows that still have NA Values --> Instead of dropping maybe replacing with default value? Decision should strongly depend on the actual column
